...
/**
 * SQLite 3 database driver using PDO.
 *
 * @package    core_dml
 * @copyright  2026 Ernesto Serrano
 * @copyright  based on work by 2008 Andrei Bautu
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sqlite3_pdo_moodle_database extends pdo_moodle_database {
    /** @var string File extension for the SQLite database file. */
    ...
    /**
     * Configure the database connection with SQLite-specific PRAGMAs.
     */
    ...
    public function sql_group_concat(string $field, string $separator = ', ', string $sort = ''): string {
        $separator = $this->pdb->quote($separator);
